...
This is a flake-based NixOS configuration managed with chezmoi for multiple hosts.

## Project Structure

- `flake.nix` - Main flake configuration defining system configurations
- `configuration.nix` - Shared base configuration for all hosts
- `modules/` - Modular service configurations
...
sudo nixos-rebuild switch --flake /home/chrash/.local/share/chezmoi/nixos#green

# Test without activating
sudo nixos-rebuild test --flake /home/chrash/.local/share/chezmoi/nixos#green

# Build without activating
sudo nixos-rebuild build --flake /home/chrash/.local/share/chezmoi/nixos#green
```
